...
from backend.model import nst2
...
storage_url = 'neuralstyle-cad83.appspot.com'
...
def nst_post():
    if request.method =='POST':
        ...
        print(refer_img_path)
        transfer_img_path = nst2.main(refer_img_path, user_img_path, tmp_folder)
        print("here1")
