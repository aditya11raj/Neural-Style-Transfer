...
const SUBMIT_PHOTO_ENDPOINT = "http://1c1f23a753a1.ngrok.io/nst_post";
...
function getSteps() {
  return ["Pick a style to apply", "Upload your image", "Style Your Image"];
}
...
function Canvas() {
  ...
  const submitPhoto = async (artist, picture) => {
    try {
      ...
      console.error(
        "An error ocurred in submitting to the backend1",
        e,
        e.message
      );
    }
